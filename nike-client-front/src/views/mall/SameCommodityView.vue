    ...
    <div class="main-container">
      <div class="nav-breadcrumb">
        ...
        <el-breadcrumb separator="/" style="font-size: 16px;">
          ...
          <div v-for="item in sameCommodityList">
          <el-breadcrumb-item><span v-text="item.categoryName"></span></el-breadcrumb-item>
          </div>
        </el-breadcrumb>
      </div>
...
export default {
  ...
  methods: {
    //網頁抬頭
    loadPageTitle() {
      this.pageTitle = this.categoryName + '- Nike';
    ...
    loadGoodList() {
      ...
      MallAPI.getGoodsByCategory(params)
          .then((response) => {
            ...
            this.sameCommodityList = this.sameCommodityList.concat(jsonResult.data.list);
