<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="goodsId" label="商品ID" width="83" align="center"
                       :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="type" label="評論類型" align="center" width="80">
        <template slot-scope="scope">
          <span v-if="scope.row.type == 0" style="color: #67c23a">{{ typeText[scope.row.type] }}</span>
          <span v-else-if="scope.row.type == 2" style="color: #F56C6C">{{ typeText[scope.row.type] }}</span>
          <span v-else-if="scope.row.type == 1" style="color: #aaa">{{ typeText[scope.row.type] }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="content" label="評論內容" align="center" width="255"
                       :show-overflow-tooltip="true"></el-table-column>
      ...
      <el-table-column prop="gmtCreate" label="創建時間" width="180" align="center"></el-table-column>
