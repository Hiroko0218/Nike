package com.yafeng.nike.passport.config;
...
public class Knife4jConfiguration {
     ...
     * 標題
     */
    private static final String TITLE = "Nike商城-單點登入服務-線上API文檔";
    /**
     * 簡介
     */
    private static final String DESCRIPTION = "Nike商城-單點登入服務-線上API文檔";
    /**
     * 服務條款URL
     */
