package com.yafeng.nike.admin.content.config;
...
public class Knife4jConfiguration {
     ...
     * 標題
     */
    private static final String TITLE = "Nike商城-資訊管理後台服務-線上API文檔";
    /**
     * 簡介
     */
    private static final String DESCRIPTION = "Nike商城-資訊管理後台服務-線上API文檔";
    /**
     * 服務條款URL
     */
