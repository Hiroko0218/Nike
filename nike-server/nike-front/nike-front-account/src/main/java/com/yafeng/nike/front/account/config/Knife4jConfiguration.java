package com.yafeng.nike.front.account.config;
...
public class Knife4jConfiguration {
     ...
     * 標題
     */
    private static final String TITLE = "Nike商城-帳號管理前台服務-線上API文檔";
    /**
     * 簡介
     */
    private static final String DESCRIPTION = "Nike商城-帳號管理前台服務-線上API文檔";
    /**
     * 服務條款URL
     */
