...
(
    ...
    name         VARCHAR(32)      DEFAULT '' COMMENT '類別名稱',
    parent_id    BIGINT UNSIGNED  DEFAULT 0 COMMENT '父級類別ID，如果無父級，則為0',
    depth        TINYINT UNSIGNED DEFAULT 0 COMMENT '深度，最讚級類別的深度為1，次級為2，以此類推',
    keywords     VARCHAR(255)     DEFAULT '' COMMENT '關鍵詞列表，各關鍵詞使用英文的逗號分隔',
    sort         TINYINT UNSIGNED DEFAULT 0 COMMENT '排序序號',
    icon         VARCHAR(255)     DEFAULT '' COMMENT '圖標圖片的URL',
...
(
    ...
    bar_code               VARCHAR(32)      DEFAULT '' COMMENT '商品條形碼',
...
(
    ...
    city_code      VARCHAR(32)      DEFAULT '' COMMENT '市編碼',
    area           VARCHAR(256)     DEFAULT '' COMMENT '區名稱',
    area_code      VARCHAR(32)      DEFAULT '' COMMENT '區編碼',
...
(
    ...
    pay_channel      INT UNSIGNED     DEFAULT 0 COMMENT '支付渠道：1=LINE Pay，2=Apple Pay',
    pay_method       INT UNSIGNED     DEFAULT 0 COMMENT '支付方式：1=線上支付，2=貨到付款',
