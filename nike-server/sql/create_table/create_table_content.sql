...
(
    ...
    name         VARCHAR(16)      DEFAULT '' COMMENT '類別名稱',
...
(
    ...
    category_name VARCHAR(16)      DEFAULT '' COMMENT '類別名稱',
    ...
    sort          TINYINT UNSIGNED DEFAULT 0 COMMENT '排序序號',
    up_count      INT UNSIGNED     DEFAULT 0 COMMENT '讚數量',
    down_count    INT UNSIGNED     DEFAULT 0 COMMENT '倒讚數量',
...
(
    ...
    gmt_modified DATETIME        DEFAULT NULL COMMENT '數據最後修改時間',
    PRIMARY KEY (id)
) COMMENT '內容-文章詳情' CHARSET = utf8mb4;
...
(
    ...
    op_type        TINYINT UNSIGNED DEFAULT 0 COMMENT '操作類型，0=倒讚，1=讚',
    gmt_create     DATETIME         DEFAULT NULL COMMENT '數據創建時間',
    gmt_modified   DATETIME         DEFAULT NULL COMMENT '數據最後修改時間',
    PRIMARY KEY (id)
) COMMENT '內容-讚與倒讚日誌' CHARSET = utf8mb4;
...
(
    ...
    resource_id    BIGINT UNSIGNED  DEFAULT 0 COMMENT '資源ID',
    resource_brief VARCHAR(255)     DEFAULT '' COMMENT '資源摘要，截取的文章標題或評論',
    content        VARCHAR(512)     DEFAULT '' COMMENT '評論內容',
    ip             VARCHAR(32)      DEFAULT '' COMMENT '倒讚數量',
...
(
    ...
    check_user_name VARCHAR(32)      DEFAULT '' COMMENT '審核人用戶名',
    check_remarks   VARCHAR(64)      DEFAULT '' COMMENT '審核備注',
    gmt_check       DATETIME         DEFAULT NULL COMMENT '審核時間',
    gmt_create      DATETIME         DEFAULT NULL COMMENT '數據創建時間',
    gmt_modified    DATETIME         DEFAULT NULL COMMENT '數據最後修改時間',
    PRIMARY KEY (id)
) COMMENT '內容-審核日誌' CHARSET = utf8mb4;