package com.yafeng.nike.attachment.config;
...
public class Knife4jConfiguration {
     ...
     * 標題
     */
    private static final String TITLE = "Nike商城-附件上傳服務-線上API文檔";
    /**
     * 簡介
     */
    private static final String DESCRIPTION = "Nike商城-附件上傳服務-線上API文檔";
    /**
     * 服務條款URL
     */
